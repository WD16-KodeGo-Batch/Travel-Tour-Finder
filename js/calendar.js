        ...
        calendarEvents: [
            {
              ...
              description: "The heart touching greetings will make feel anyone very special. Wish your near and dear one with our speacial greetings.",
              type: "holiday", // Event type (required)
              everyYear: true // Same event every year (optional)
            },
            {
              id: 'event2', // Event's ID (required)
              name: "Presentation", // Event name (required)
              date: "October/22/2022", // Event date (required)
              description: "Guys Pasensya na kung magprepresent na this day wala ako kasi may pasok ako salamat sa inyong lahat.",
              type: "holiday", // Event type (required)
              everyYear: false // Same event every year (optional)
            },
            {
              id: 'event3', // Event's ID (required)
              name: "Calendar Date Made", // Event name (required)
              date: "October/16/2022", // Event date (required)
              description: "Guys sana magustuhan nyo hehe",
              type: "regularday", // Event type (required)
              everyYear: false // Same event every year (optional)
            },
            {
              id: 'event4', // Event's ID (required)
              name: "Test Schedule", // Event name (required)
              date: "October/17/2022", // Event date (required)
              description: "It's Monday",
              type: "holiday", // Event type (required)
              everyYear: false // Same event every year (optional)
            },
          ]
